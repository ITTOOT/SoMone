...
# In this example, we show how to plot the results of various $\alpha$ penalization values
# from the results of cross-validation using scikit-learn's LassoCV. This is useful to see
# how much the error of the optimal alpha actually varies across CV folds.
