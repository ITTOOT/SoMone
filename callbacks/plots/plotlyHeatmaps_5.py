...
# In this example, we show how to visualize the results of a grid search on a DecisionTreeRegressor. 7
# The first plot shows how to visualize the score of each model parameter on individual splits (grouped using facets).
# The second plot aggregates the results of all splits such that each box represents a single model.
